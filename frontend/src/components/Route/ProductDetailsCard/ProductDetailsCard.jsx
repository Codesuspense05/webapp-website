...
import { RxCross1, RxIconjarLogo } from "react-icons/rx";
    ...
    <div className="bg-[#fff]">
      {data ? (
        <div className="fixed w-full h-screen top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center">
          <div className="w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[45vh] max-400px:h-[75vh]  bg-white rounded-md shadow-sm relative p-4">
            <RxCross1
              size={30}
            ...
            <div className="block w-[full] 800px:flex">
              <div className="w-full 800px:w-[50%] ">
                <img src={`${data.images && data.images[0]?.url}`} className="max-400px:w-[100%]" alt="" />
          ...
          <h5 className={"text-[15px] text-gray-500 pt-0 pb-0.5 text-shadow flex"}><h4 className="text-orange-500 flex pr-2">Colortype:</h4> {data.color}</h5>
                ...
                <div className="flex items-center mt-12 justify-end pr-3">
                  <div>
                    ...
                    <span className="border text-gray-800 font-medium px-4 py-[10px]">
                      {count}
                    </span>
                    <button
                      className="bg-gradient-to-r from-blue-400 to-blue-500 text-white font-bold rounded px-4 py-2 shadow-lg hover:opacity-75 transition duration-300 ease-in-out"
                ...
                <div
                  className={`${styles.button} w-full mt-6 rounded-[4px] h-11 flex items-center`}
                ...
                <div className="flex  items-center max-400px:justify-start border">
                  ...
                  <div className="flex items-center justify-end"><RxIconjarLogo size={50} className="max-400px:ml-[120px] 800px:ml-[350px] text-blue-500"/></div>
                </div>
              </div>
