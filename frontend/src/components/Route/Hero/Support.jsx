...
const Contact = () => {
  return (
    <>
      <section
        className="bg-white  pt-20 pb-5  overflow-hidden relative z-10 ease-in duration-300"
        data-aos="fade-down"
        data-aos-delay="400"
      >
          ...
          <div className="flex flex-wrap  lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 text-[22px] text-gray-500 font-bold uppercase text-dark sm:text-[20px] lg:text-[20px] xl:text-[20px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-4/12">
              <div className="relative p-8 bg-white rounded-lg border shadow-xl sm:p-12 xl:p-10">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
