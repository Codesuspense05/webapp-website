...
const FAQPage = () => {
  return (
    <div>
      <div className="800px:hidden max-400px:hidden"><Header activeHeading={5}  /></div>
      <Faq />
      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@MWRSMS.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@MWRSMS.com, or by calling us at (02) 123-4567
                between the hours of 9am and 5pm, Monday To Sunday.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-500  pb-4">
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Unfortunately, we are not cancellations orders, but we are able to
                make changes product order. If you no longer want the items
                you've ordered, you can change item within a day of delivery.
              </p>
            </div>
          )}
        </div>
