                   ...
                   <ul className="pl-10 bg-white items-center justify-center ">
                      <Link to={"/"}>
                        <li className="py-2 cursor-pointer hover:p-2 justify-center  hover:text-blue-500 text-gray-500">
                          <div className="flex text-black justify-start font-bold"><BiHomeAlt className="mr-2" size={21}/>Home</div>
                        </li>
                      </Link>
                      <hr />
                      ...
                      <Link to={"/about"}>
                        <li className="py-2 cursor-pointer hover:p-2  hover:text-blue-500  text-gray-500">
                          <div className="flex text-black font-bold justify-start"><IoAlbumsOutline className="mr-2" size={21}/> About us</div>
                        </li>
                      </Link>
                      <hr />
                      ...
                      <Link to={"/webproducts"}>
                        <li className="py-2 cursor-pointer hover:p-2  hover:text-blue-500 text-gray-500">
                          <div className="flex text-black font-bold justify-start"><RiProductHuntLine className="mr-2" size={21}/>Product</div>
                        </li>
                      </Link>
                      <hr />
                      ...
                      <Link to={"/websupport"}>
                        <li className="py-2 cursor-pointer hover:p-2  hover:text-blue-500 text-gray-500">
                          <div className="flex text-black font-bold justify-start"><IoCallOutline className="mr-2" size={21}/>Support</div>
                        </li>
                      </Link>
                      <hr />
                      ...
                      <Link to={"/webfaq"}>
                        <li className="py-2 cursor-pointer hover:p-2  hover:text-blue-500 text-gray-500">
                          <div className="flex text-black font-bold justify-start"><BsQuestionCircle className="mr-2" size={21}/>Faq</div>
                        </li>
                      </Link>
